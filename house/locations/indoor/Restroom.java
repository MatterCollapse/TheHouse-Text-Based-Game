...
public class Restroom extends Location
{
    ...
    public void enter()
    {
        ...
        System.out.println("It is dusty, and you can see spots of mold, but you have to admit it's cleaner than you expected. " + END_OF_LINE + "The room is small and leads out into the kitchen. If you needed to hide, this wouldn't be the place. " + END_OF_LINE + "You can hear what is happening in nearby rooms if you listen closer. ");
